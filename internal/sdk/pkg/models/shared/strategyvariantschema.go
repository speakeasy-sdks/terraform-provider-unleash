...
func (c *StrategyVariantSchema) UnmarshalJSON(bs []byte) error {
	data := _StrategyVariantSchema{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = StrategyVariantSchema(data)
...
func (c StrategyVariantSchema) MarshalJSON() ([]byte, error) {
	out := map[string]interface{}{}
	bs, err := json.Marshal(_StrategyVariantSchema(c))
	if err != nil {
		return nil, err
	}
