...
func (c *EventSchema) UnmarshalJSON(bs []byte) error {
	data := _EventSchema{}
	...
	*c = EventSchema(data)
	...
	delete(additionalFields, "preData")
...
func (c EventSchema) MarshalJSON() ([]byte, error) {
	out := map[string]interface{}{}
	bs, err := json.Marshal(_EventSchema(c))
	if err != nil {
		return nil, err
	}
