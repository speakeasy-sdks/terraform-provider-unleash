...
type _HealthReportSchema HealthReportSchema

func (c *HealthReportSchema) UnmarshalJSON(bs []byte) error {
	data := _HealthReportSchema{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = HealthReportSchema(data)
	...
	delete(additionalFields, "activeCount")
	...
	delete(additionalFields, "members")
	delete(additionalFields, "mode")
	delete(additionalFields, "name")
	delete(additionalFields, "potentiallyStaleCount")
	delete(additionalFields, "staleCount")
	delete(additionalFields, "stats")
	delete(additionalFields, "updatedAt")
...
func (c HealthReportSchema) MarshalJSON() ([]byte, error) {
	out := map[string]interface{}{}
	bs, err := json.Marshal(_HealthReportSchema(c))
	if err != nil {
		return nil, err
	}
