...
func (c *ProjectOverviewSchema) UnmarshalJSON(bs []byte) error {
	data := _ProjectOverviewSchema{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = ProjectOverviewSchema(data)
...
func (c ProjectOverviewSchema) MarshalJSON() ([]byte, error) {
	out := map[string]interface{}{}
	bs, err := json.Marshal(_ProjectOverviewSchema(c))
	if err != nil {
		return nil, err
	}
