...
func (c *CreateUserSchema) UnmarshalJSON(bs []byte) error {
	data := _CreateUserSchema{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = CreateUserSchema(data)
	...
	delete(additionalFields, "sendEmail")
...
func (c CreateUserSchema) MarshalJSON() ([]byte, error) {
	out := map[string]interface{}{}
	bs, err := json.Marshal(_CreateUserSchema(c))
	if err != nil {
		return nil, err
	}
