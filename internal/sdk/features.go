...
func (s *features) AddTag(ctx context.Context, request operations.AddTagRequest) (*operations.AddTagResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "TagSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) BulkToggleFeaturesEnvironmentOff(ctx context.Context, request operations.BulkToggleFeaturesEnvironmentOffRequest) (*operations.BulkToggleFeaturesEnvironmentOffResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "BulkToggleFeaturesSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) ChangeProject(ctx context.Context, request operations.ChangeProjectRequest) (*operations.ChangeProjectResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "ChangeProjectSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) CloneFeature(ctx context.Context, request operations.CloneFeatureRequest) (*operations.CloneFeatureResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CloneFeatureSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) CreateFeature(ctx context.Context, request operations.CreateFeatureRequest) (*operations.CreateFeatureResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateFeatureSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) OverwriteFeatureVariantsOnEnvironments(ctx context.Context, request operations.OverwriteFeatureVariantsOnEnvironmentsRequest) (*operations.OverwriteFeatureVariantsOnEnvironmentsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PushVariantsSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) StaleFeatures(ctx context.Context, request operations.StaleFeaturesRequest) (*operations.StaleFeaturesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "BatchStaleSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) UpdateFeature(ctx context.Context, request operations.UpdateFeatureRequest) (*operations.UpdateFeatureResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateFeatureSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) UpdateFeatureStrategy(ctx context.Context, request operations.UpdateFeatureStrategyRequest) (*operations.UpdateFeatureStrategyResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateFeatureStrategySchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *features) UpdateTags(ctx context.Context, request operations.UpdateTagsRequest) (*operations.UpdateTagsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "UpdateTagsSchema", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
